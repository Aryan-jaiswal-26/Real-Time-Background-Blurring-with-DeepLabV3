...
**Progress**: Modernized the Real-Time Background Blurring project for 2026

**Changes Made**:
- ✅ Migrated from TensorFlow 1.4.0 to TensorFlow 2.20+
- ✅ Updated Python compatibility from 3.5 to 3.13+
- ✅ Fixed deprecated Keras APIs (`_keras_shape`, `conv_utils`)
- ✅ Updated model naming for TensorFlow 2.x compliance
- ✅ Set up virtual environment for better dependency management
- ✅ Installed modern packages: tensorflow, opencv-python, matplotlib, imutils
- ✅ Tested successfully - application processes ~200-250ms per frame
- ✅ Updated README with latest installation instructions and requirements

**Thoughts**: The migration from TensorFlow 1.x to 2.x required several compatibility fixes, but the model now works perfectly with modern Python and deep learning ecosystem. The transition highlights how much the ML/DL frameworks have evolved over the years.

**Technology Stack**: Python 3.13, TensorFlow 2.20, Keras API, OpenCV, DeepLabV3+ with MobileNetV2

---

## Day 0 : June 06 , 2018
 
**Today's Progress** : Setting up the enviornment, installing tensorflow and keras
